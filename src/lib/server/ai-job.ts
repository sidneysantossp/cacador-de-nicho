...
export async function runAiJob<T>(kind:'analyze'|'script'|'channel-study'|'opportunity-report'|'universe-intelligence'|'universe-curves',item:string,work:()=>Promise<T>):Promise<T>{
